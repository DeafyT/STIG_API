...
## Supporting Scripts
Inside of this directory, I will place any scripts that I decide will help with the overall API. Currently, there is a BASH script that can be run on Mac or Linux that will take a new STIG download and export it to the designated directory and will also take the previous STIGs and move them to a back up directory.
